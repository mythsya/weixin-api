...
public final class GlobalReturnCodes {
    ...
    public final static Map<Integer, String> ALL_CODES = ImmutableMap.copyOf(new HashMap<Integer, String>() {
...

        {
            ...
            put(0, "请求成功");
            put(40001, "获取access_token时AppSecret错误，或者access_token无效。请开发者认真比对AppSecret的正确性，或查看是否正在为恰当的公众号调用接口");
            put(40002, "不合法的凭证类型");
            ...
            put(40013, "不合法的AppID，请开发者检查AppID的正确性，避免异常字符，注意大小写");
            put(40014, "不合法的access_token，请开发者认真比对access_token的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口");
            put(40015, "不合法的菜单类型");
            put(40016, "不合法的按钮个数");
            put(40017, "不合法的按钮个数");
            ...
            put(41009, "缺少openid");
            put(42001, "access_token超时，请检查access_token的有效期，请参考基础支持-获取access_token中，对access_token的详细机制说明");
    ...
    /**
     * 根据返回值代码判断接口调用是由公众号平台系统繁忙造成的，以便判断后续是否再次调用
     *
     * @param code
     *            接口返回值代码
     * @return true/false
