...
public class WxMsgAESTest {
    ...
    public void testEncrypt() {
        try {
            WxMsgAES pc = new WxMsgAES(token, encodingAesKey, appId);
    ...
    @Test
    public void testVerifyUrl() throws WxAesException {
        WxMsgAES wxaes = new WxMsgAES("QDG6eK", "jWmYm7qr5nMoAUwZRjGtBxmz3KA1tkAj3ykkR6q2B2C", "wx5823bf96d3bd56c7");
        ...
        wxaes.verifyUrl(verifyMsgSig, timeStamp, nonce, echoStr);
        // 只要不抛出异常就好
    }
